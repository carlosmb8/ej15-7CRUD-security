package com.example.ej157crudsecurity.security.config;

import com.example.ej157crudsecurity.application.PersonaService;
import com.example.ej157crudsecurity.security.filter.JwtRequestFilter;
import com.example.ej157crudsecurity.security.service.UsuarioDetailsService;
...
//                .antMatchers("/personas").hasRole("USER")
                .antMatchers("/personas").access("hasRole('USER') or hasRole('ADMIN')")
